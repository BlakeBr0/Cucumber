...
public class GuiGuide extends GuiScreen {
	...
	public GuiGuide(ItemStack book, Guide guide) {
		...
		if (this.entry != null && this.entryId == -1) this.entryId = 0;
	}
	...
	public void initGui() {
		...
		this.exit = this.addButton(new GuiButtonExit(10010, this.xStart + 412, this.yStart + 15));
	...
	public void render(int mouseX, int mouseY, float partialTicks) {
		...
		if (this.entry != null) {
			RenderHelper.drawScaledCenteredWrappedTextY(this.fontRenderer, Colors.BOLD + this.entry.getTitle(), this.xStart + 227, this.yStart + 25, 1.0F, 186, -1, 0, false);
