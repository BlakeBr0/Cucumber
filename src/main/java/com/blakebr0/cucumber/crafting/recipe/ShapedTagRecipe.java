...
public class ShapedTagRecipe extends ShapedNoMirrorRecipe {
    ...
    public static class Serializer extends ForgeRegistryEntry<IRecipeSerializer<?>> implements IRecipeSerializer<ShapedTagRecipe> {
        @Override
        public ShapedTagRecipe read(ResourceLocation recipeId, JsonObject json) {
        ...
        @Override
        public ShapedTagRecipe read(ResourceLocation recipeId, PacketBuffer buffer) {
        ...
        @Override
        public void write(PacketBuffer buffer, ShapedTagRecipe recipe) {
