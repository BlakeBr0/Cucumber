...
public class BaseSpearItem extends BaseItem {
    ...
    public BaseSpearItem(
        ...
        super(id, properties.compose(p -> p.spear(material, attackDuration, damageMultiplier, delay, dismountTime, dismountThreshold, knockbackTime, knockbackThreshold, damageTime, damageThreshold)));
    }
}
